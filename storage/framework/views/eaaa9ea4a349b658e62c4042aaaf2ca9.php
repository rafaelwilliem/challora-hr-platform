        ...
        <?php if(session('flash_toast')): ?>
            <div class="bg-accent text-[#111] p-4 mb-8 border-2 border-black font-black uppercase text-[10px] tracking-widest gsap-item shadow-[4px_4px_0_black]">
                <div class="flex items-center gap-2">
                    ...
                    <?php echo e(session('flash_toast')['message']); ?>

                </div>
            </div>
        <?php endif; ?>

        <form method="post" action="<?php echo e(route('login')); ?>" class="gsap-item">
            <?php echo csrf_field(); ?>
            ...
            <div class="mt-12 text-center">
                <p class="text-[11px] font-bold text-gray-500 uppercase tracking-widest">
                    New Here? <a href="<?php echo e(route('register')); ?>"
...
<?php echo $__env->make('layouts.auth', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\challorav2\resources\views/auth/login.blade.php ENDPATH**/ ?>