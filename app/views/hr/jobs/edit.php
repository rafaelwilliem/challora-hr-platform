    ...
    <div class="card-body">
        ...
        <form method="post" action="<?= BASE_URL ?>/index.php?url=hr/jobs/edit&id=<?= (int)($job['id'] ?? 0) ?>">
            ...
            <div class="mb-3">
                ...
                <textarea class="form-control" id="short_description" name="short_description" rows="2" maxlength="255" placeholder="Ringkasan 2-3 kalimat untuk tampilan di card"><?= e($old['short_description'] ?? '') ?></textarea>
                <small class="text-muted">Ditampilkan di card lowongan.</small>
            </div>
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control mt-2" name="location" placeholder="Alamat detail" value="<?= e($old['location']) ?>">
            </div>
            <div class="mb-3">
            ...
            <div class="row">
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <input type="number" class="form-control" id="max_applicants" name="max_applicants" value="<?= e($old['max_applicants']) ?>" min="1">
                </div>
            </div>
            <div class="mb-3">
